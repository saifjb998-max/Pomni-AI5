...
const client = new Client({
  ...
  owners: [
  // Owner 1
    { name: "VA", lid: "247579682029763@lid", jid: "212690125725@s.whatsapp.net" },
  // Owner 2
    { name: "emam", lid: "221307316789354@lid", jid: "212690125725@s.whatsapp.net" },
  // Owner 3
    { name: "Sukuna", jid: "212690125725@s.whatsapp.net", lid: "50414477168824@lid" },
  // Owner 4 
   { name: "عمورتي", jid: "212690125725@s.whatsapp.net", lid: "51664513925368@lid" }
  ],
